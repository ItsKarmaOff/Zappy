...
** Libmy
** File description:
** The file containing the my_nbr_double_to_str_hexa function
*/
/**
 * @file my_nbr_double_to_str_hexa.c
 * @brief The file containing the my_nbr_double_to_str_hexa function
 * @author Nicolas TORO
 */
