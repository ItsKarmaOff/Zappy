...
static bool is_separator(char *str, size_t index,
...
size_t count_words(char *str, char *separator, separator_type_t type)
{
    size_t nb_words = 0;
    bool add_word = true;
...
static void move_save(char *str, size_t *saved_index,
    char *separator, separator_type_t type)
{
    size_t len_separator = my_strlen(separator) - 1;
...
size_t count_letters(char *str, size_t *saved_index,
    char *separator, separator_type_t type)
{
    size_t nb_letters = 0;
