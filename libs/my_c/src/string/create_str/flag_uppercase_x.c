...
** Libmy
** File description:
** The file containing the flag_uppercase_x function
*/
/**
 * @file flag_uppercase_x.c
 * @brief The file containing the flag_uppercase_x function
 * @author Nicolas TORO
 */
...
static char *str_from_char(format_t *str_struct)
{
    ...
    char *converted_nbr = my_nbr_to_str_unsigned(
        nbr, BASE_16_UPPERCASE, sizeof(unsigned char));
...
static char *str_from_short(format_t *str_struct)
{
    ...
    str_struct->format_list, unsigned int);
    char *converted_nbr = my_nbr_to_str_unsigned(
        nbr, BASE_16_UPPERCASE, sizeof(unsigned short));
...
static char *str_from_uint(format_t *str_struct)
{
    ...
    str_struct->format_list, unsigned int);
    char *converted_nbr = my_nbr_to_str_unsigned(
        nbr, BASE_16_UPPERCASE, sizeof(unsigned int));
...
static char *str_from_long(format_t *str_struct)
{
    ...
    char *converted_nbr = my_nbr_to_str_unsigned(
        nbr, BASE_16_UPPERCASE, sizeof(unsigned long));
...
static char *str_from_long_long(format_t *str_struct)
{
    ...
    char *converted_nbr = my_nbr_to_str_unsigned(
        nbr, BASE_16_UPPERCASE, sizeof(unsigned long long));
...
static char *str_from_ptrdiff(format_t *str_struct)
{
    ...
    char *converted_nbr = my_nbr_to_str_unsigned(
        nbr, BASE_16_UPPERCASE, sizeof(ptrdiff_t));
