...
** Libmy
** File description:
** The file containing the flag_lowercase_b function
*/
/**
 * @file flag_lowercase_b.c
 * @brief The file containing the flag_lowercase_b function
 * @author Nicolas TORO
 */
...
static char *str_from_char(format_t *str_struct)
{
    ...
    char *converted_nbr = my_nbr_to_str_unsigned(
        nbr, BASE_2, sizeof(unsigned char));
...
static char *str_from_short(format_t *str_struct)
{
    ...
    str_struct->format_list, unsigned int);
    char *converted_nbr = my_nbr_to_str_unsigned(
        nbr, BASE_2, sizeof(unsigned short));
...
static char *str_from_uint(format_t *str_struct)
{
    ...
    str_struct->format_list, unsigned int);
    char *converted_nbr = my_nbr_to_str_unsigned(
        nbr, BASE_2, sizeof(unsigned int));
...
static char *str_from_long(format_t *str_struct)
{
    ...
    char *converted_nbr = my_nbr_to_str_unsigned(
        nbr, BASE_2, sizeof(unsigned long));
...
static char *str_from_long_long(format_t *str_struct)
{
    ...
    char *converted_nbr = my_nbr_to_str_unsigned(
        nbr, BASE_2, sizeof(unsigned long long));
