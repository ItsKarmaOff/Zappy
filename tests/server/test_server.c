...
{
    create_server(12, (char *[]){"zappy_server", "-p", "4240", "-x", "10", "-y", "10", "-n", "team1", "team2", "-c", "1"});
}
...
Test(left, test_left_command, .init = redirect_all_std, .exit_code = 0)
{
...
Test(right, test_right_command, .init = redirect_all_std, .exit_code = 0)
{
